...
parser.add_argument("--save_path", type=str, default="./results.mp4", help="Path to save the output video")
...
def main_worker():
    ...
    writer = cv2.VideoWriter(save_path, cv2.VideoWriter_fourcc('X', '2', '6', '4'),
                             default_fps, size)
